...
describe('addProductToFreeze()', function(){
    it('should contain the right action type', function(){
    ...
    it('should have the default amount in the action payload', function(){
        const action = actions.addProductToFreezer('foo');
...
describe('doSomething()', function(){
    ...
    it('should dispatch the "FOO" action', function(){
        ...
        const action = actions.doSomething();  // returns a function function(dispatch, getState) 
