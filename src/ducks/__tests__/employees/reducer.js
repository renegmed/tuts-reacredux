...
describe('Fetching employees', function() {
    ...
    describe('Successful fetch', function() {
        it('should set the loading property to `false` when the data fetching successful', function(){ 
    ...
    describe('Failed fetch', function() {
        it('should set the loading property to `false` when the data fetching failed', function(){ 
